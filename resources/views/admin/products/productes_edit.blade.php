...
<div class="py-12">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <form action="{{ route('productes_update',$product) }}"
                  method="POST"
                ...
                <div>
                    ...
                    <input type="number" id="price" value="{{$product->price}}" name="price" step="0.01" required
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description"
                              ...
                              rows="4"
                              class="w-full border border-solid border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"
                              placeholder="Enter product description">{{ old('description', $product->description) }}
                            </textarea>
                    @error('description')
                        <p class="text-sm text-red-600 mt-1 font-medium">{{ $message }}</p>
                    @enderror
